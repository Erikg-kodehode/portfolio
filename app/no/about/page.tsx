  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      <header className="mb-8 text-center">
        <h1 className="text-2xl font-bold text-blue-800 dark:text-blue-300 mb-3 transition-colors duration-200">
          {t.about.title}
        </h1>
      ...
      <section className="mb-8 hero-container">
      ...
      <section className="mb-8">
        ...
        <div className="space-y-4">
          <article className="bg-slate-50 dark:bg-slate-800 rounded-lg shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
            <div className="p-5">
              <h3 className="text-xl font-semibold text-slate-800 dark:text-slate-200 mb-2 transition-colors duration-200">{t.about.journey.sections.fromRobots.title}</h3>
              ...
              <ul className="space-y-1.5 text-slate-600 dark:text-slate-400 text-sm transition-colors duration-200">
                {t.about.goals.shortTerm.items.map((item, index) => (
                  <li key={index} className="flex items-start">
                    ...
                    <span className="dark:text-green-white">{item}</span>
                  </li>
                ))}
              </ul>
            </div>
