  ...
  return (
    ...
    >
      ...
      <div className="
        ...
        relative
      ">
        <h2 className="text-base font-bold text-blue-900 dark:text-blue-200 mb-2 transition-colors duration-300 tracking-tight leading-snug group-hover:text-blue-800 dark:group-hover:text-blue-100">
          {title}
        </h2>
        <div className="flex flex-col flex-grow gap-4">
          <div className="min-h-[42px] flex-shrink-0">
            <p className="text-blue-800/70 dark:text-blue-300/70 text-sm leading-relaxed transition-colors duration-300 line-clamp-2 text-balance">
              {description}
            </p>
          </div>
          
          <div className="mt-auto">
            <h3 className="text-xs font-semibold uppercase text-blue-900/60 dark:text-blue-200/60 mb-1.5 transition-colors duration-300">
              Technologies
            </h3>
      ...
      <div 
        className="
          buttons-wrapper
          flex justify-start gap-3 py-4 px-4 mt-4
