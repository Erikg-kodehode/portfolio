...
export default function HomePage() {
  return (
    <div className="container mx-auto px-4 py-8 md:py-12 max-w-5xl">
      <section className="bg-gradient-to-br from-blue-300 to-blue-500 dark:from-blue-700 dark:to-blue-950 rounded-lg shadow-md overflow-hidden transition-colors duration-200">
        <div className="flex flex-col md:flex-row items-center">
          <div className="p-6 md:p-8 md:w-3/5">
            <h1 className="text-3xl md:text-4xl font-bold text-blue-50/90 dark:text-green-white/90 mb-4">
              Hei, jeg er <span className="text-blue-50/90 dark:text-green-white/90">Erik Gulliksen</span>
            </h1>
            
            <p className="text-lg text-blue-50/90 dark:text-green-white/90 mb-6 leading-relaxed">
          ...
          <div className="p-6 md:w-2/5 flex justify-center">
            <div className="relative w-64 h-64 overflow-hidden rounded-full border-4 border-blue-50/90 dark:border-slate-700 shadow-md bg-slate-200 dark:bg-slate-700 transition-colors duration-200">
              <Image
